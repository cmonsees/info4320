...
const int motorEnablePin2 = D3;
const int leftSidePin2 = D4;
const int rightSidePin2 = D5;
...
void loop(){
  ...
  if (D_Read != 0) // If the analog reading is non-zero
  {
    ...
    int motorStrength2 = map(force2, 1, 1000, 0, 255);
    
    analogWrite(motorEnablePin2, motorStrength2);
